...
public class SumatoriaMenorA extends CriterioFiltrado {
	...
	public Boolean aplicarCriterio(Indicador indicador, Double valor, Stream<Periodo> periodosDeInteres) throws NoSePudoAplicarCriterioException {
		...
		try {
			...
			return periodosDeInteres.mapToDouble(periodo -> indicador.calcularValor(new Contexto(periodo.getCuentas()))).sum() < valor;
		} 
	...
	public String toString() {
		...
		return "Filtro: Sumatoria Menor a X valor";
	}
}